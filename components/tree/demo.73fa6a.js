(window.webpackJsonp=window.webpackJsonp||[]).push([[187],{3243:function(T,V,d){T.exports={"basic-controlled":d(3971),basic:d(3972),"big-data":d(3973),"customized-icon":d(3974),directory:d(3975),draggable:d(3976),dynamic:d(3977),line:d(3978),search:d(3979),"switcher-icon":d(3980),"virtual-scroll":d(3981)}},3971:function(T,V,d){T.exports={content:{"zh-CN":[["p","受控操作示例"]],"en-US":[["p","Controlled mode lets parent nodes reflect the status of child nodes more intelligently."]]},meta:{order:1,title:{"zh-CN":"受控操作示例","en-US":"Controlled Tree"},filename:"components/tree/demo/basic-controlled.md",id:"components-tree-demo-basic-controlled"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
`},preview:function(){var h=d(0),H=d(26);function v(g){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?v=function(u){return typeof u}:v=function(u){return u&&typeof Symbol=="function"&&u.constructor===Symbol&&u!==Symbol.prototype?"symbol":typeof u},v(g)}var k=D(d(0)),b=d(9);function S(){if(typeof WeakMap!="function")return null;var g=new WeakMap;return S=function(){return g},g}function D(g){if(g&&g.__esModule)return g;if(g===null||v(g)!=="object"&&typeof g!="function")return{default:g};var p=S();if(p&&p.has(g))return p.get(g);var u={},e=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var l in g)if(Object.prototype.hasOwnProperty.call(g,l)){var r=e?Object.getOwnPropertyDescriptor(g,l):null;r&&(r.get||r.set)?Object.defineProperty(u,l,r):u[l]=g[l]}return u.default=g,p&&p.set(g,u),u}function C(g,p){return W(g)||z(g,p)||K(g,p)||N()}function N(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function K(g,p){if(!g)return;if(typeof g=="string")return R(g,p);var u=Object.prototype.toString.call(g).slice(8,-1);if(u==="Object"&&g.constructor&&(u=g.constructor.name),u==="Map"||u==="Set")return Array.from(g);if(u==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(u))return R(g,p)}function R(g,p){(p==null||p>g.length)&&(p=g.length);for(var u=0,e=new Array(p);u<p;u++)e[u]=g[u];return e}function z(g,p){if(typeof Symbol=="undefined"||!(Symbol.iterator in Object(g)))return;var u=[],e=!0,l=!1,r=void 0;try{for(var w=g[Symbol.iterator](),P;!(e=(P=w.next()).done)&&!(u.push(P.value),p&&u.length===p);e=!0);}catch(j){l=!0,r=j}finally{try{!e&&w.return!=null&&w.return()}finally{if(l)throw r}}return u}function W(g){if(Array.isArray(g))return g}var F=[{title:"0-0",key:"0-0",children:[{title:"0-0-0",key:"0-0-0",children:[{title:"0-0-0-0",key:"0-0-0-0"},{title:"0-0-0-1",key:"0-0-0-1"},{title:"0-0-0-2",key:"0-0-0-2"}]},{title:"0-0-1",key:"0-0-1",children:[{title:"0-0-1-0",key:"0-0-1-0"},{title:"0-0-1-1",key:"0-0-1-1"},{title:"0-0-1-2",key:"0-0-1-2"}]},{title:"0-0-2",key:"0-0-2"}]},{title:"0-1",key:"0-1",children:[{title:"0-1-0-0",key:"0-1-0-0"},{title:"0-1-0-1",key:"0-1-0-1"},{title:"0-1-0-2",key:"0-1-0-2"}]},{title:"0-2",key:"0-2"}],A=function(){var p=(0,k.useState)(["0-0-0","0-0-1"]),u=C(p,2),e=u[0],l=u[1],r=(0,k.useState)(["0-0-0"]),w=C(r,2),P=w[0],j=w[1],I=(0,k.useState)([]),m=C(I,2),y=m[0],s=m[1],o=(0,k.useState)(!0),c=C(o,2),f=c[0],x=c[1],_=function(a){console.log("onExpand",a),l(a),x(!1)},E=function(a){console.log("onCheck",a),j(a)},n=function(a,i){console.log("onSelect",i),s(a)};return k.default.createElement(b.Tree,{checkable:!0,onExpand:_,expandedKeys:e,autoExpandParent:f,onCheck:E,checkedKeys:P,onSelect:n,selectedKeys:y,treeData:F})};return k.default.createElement(A,null)}}},3972:function(T,V,d){T.exports={content:{"zh-CN":[["p","最简单的用法，展示可勾选，可选中，禁用，默认展开等功能。"]],"en-US":[["p","The most basic usage, tell you how to use checkable, selectable, disabled, defaultExpandKeys, and etc."]]},meta:{order:0,title:{"zh-CN":"基本","en-US":"Basic"},filename:"components/tree/demo/basic.md",id:"components-tree-demo-basic"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>
`},preview:function(){var h=d(0),H=d(26),v=d(9),k=[{title:"parent 1",key:"0-0",children:[{title:"parent 1-0",key:"0-0-0",disabled:!0,children:[{title:"leaf",key:"0-0-0-0",disableCheckbox:!0},{title:"leaf",key:"0-0-0-1"}]},{title:"parent 1-1",key:"0-0-1",children:[{title:h.createElement("span",{style:{color:"#1890ff"}},"sss"),key:"0-0-1-0"}]}]}],b=function(){var D=function(K,R){console.log("selected",K,R)},C=function(K,R){console.log("onCheck",K,R)};return h.createElement(v.Tree,{checkable:!0,defaultExpandedKeys:["0-0-0","0-0-1"],defaultSelectedKeys:["0-0-0","0-0-1"],defaultCheckedKeys:["0-0-0","0-0-1"],onSelect:D,onCheck:C,treeData:k})};return h.createElement(b,null)}}},3973:function(T,V,d){T.exports={content:{"zh-CN":[["p","大数据展示。"]],"en-US":[["p","Plenty of tree nodes."]]},meta:{order:99,title:{"zh-CN":"大数据","en-US":"Big data"},debug:!0,filename:"components/tree/demo/big-data.md",id:"components-tree-demo-big-data"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function(){for(var h=d(0),H=d(26),v=d(9),k=[],b=0;b<100;b+=1){for(var S=[],D=0;D<100;D+=1)S.push({title:"child ".concat(b,"-").concat(D),key:"l-".concat(b,"-").concat(D)});k.push({title:"parent ".concat(b),key:"l-".concat(b),children:S})}var C=function(){return h.createElement(v.Tree,{defaultExpandAll:!0,height:400,treeData:k})};return h.createElement(C,null)}}},3974:function(T,V,d){T.exports={content:{"zh-CN":[["p","可以针对不同的节点定制图标。"]],"en-US":[["p","You can customize icons for different nodes."]]},meta:{order:6,title:{"zh-CN":"自定义图标","en-US":"Customize Icon"},filename:"components/tree/demo/customized-icon.md",id:"components-tree-demo-customized-icon"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span>
  ...
  mountNode<span class="token punctuation">,</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function(){var h=d(0),H=d(26),v=d(9),k=d(51),b=[{title:"parent 1",key:"0-0",icon:h.createElement(k.SmileOutlined,null),children:[{title:"leaf",key:"0-0-0",icon:h.createElement(k.MehOutlined,null)},{title:"leaf",key:"0-0-1",icon:function(D){var C=D.selected;return C?h.createElement(k.FrownFilled,null):h.createElement(k.FrownOutlined,null)}}]}];return h.createElement(v.Tree,{showIcon:!0,defaultExpandAll:!0,defaultSelectedKeys:["0-0-0"],switcherIcon:h.createElement(k.DownOutlined,null),treeData:b})}}},3975:function(T,V,d){T.exports={content:{"zh-CN":[["p","内置的目录树，",["code","multiple"]," 模式支持 ",["code","ctrl(Windows)"]," / ",["code","command(Mac)"]," 复选。"]],"en-US":[["p","Built-in directory tree. ",["code","multiple"]," support ",["code","ctrl(Windows)"]," / ",["code","command(Mac)"]," selection."]]},meta:{order:7,title:{"zh-CN":"目录","en-US":"directory"},filename:"components/tree/demo/directory.md",id:"components-tree-demo-directory"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function(){var h=d(0),H=d(26),v=d(9);function k(s){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?k=function(c){return typeof c}:k=function(c){return c&&typeof Symbol=="function"&&c.constructor===Symbol&&c!==Symbol.prototype?"symbol":typeof c},k(s)}function b(s){return N(s)||C(s)||D(s)||S()}function S(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function D(s,o){if(!s)return;if(typeof s=="string")return K(s,o);var c=Object.prototype.toString.call(s).slice(8,-1);if(c==="Object"&&s.constructor&&(c=s.constructor.name),c==="Map"||c==="Set")return Array.from(s);if(c==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c))return K(s,o)}function C(s){if(typeof Symbol!="undefined"&&Symbol.iterator in Object(s))return Array.from(s)}function N(s){if(Array.isArray(s))return K(s)}function K(s,o){(o==null||o>s.length)&&(o=s.length);for(var c=0,f=new Array(o);c<o;c++)f[c]=s[c];return f}function R(s,o){if(!(s instanceof o))throw new TypeError("Cannot call a class as a function")}function z(s,o){for(var c=0;c<o.length;c++){var f=o[c];f.enumerable=f.enumerable||!1,f.configurable=!0,"value"in f&&(f.writable=!0),Object.defineProperty(s,f.key,f)}}function W(s,o,c){return o&&z(s.prototype,o),c&&z(s,c),s}function F(s,o){if(typeof o!="function"&&o!==null)throw new TypeError("Super expression must either be null or a function");s.prototype=Object.create(o&&o.prototype,{constructor:{value:s,writable:!0,configurable:!0}}),o&&A(s,o)}function A(s,o){return A=Object.setPrototypeOf||function(f,x){return f.__proto__=x,f},A(s,o)}function g(s){var o=e();return function(){var f=l(s),x;if(o){var _=l(this).constructor;x=Reflect.construct(f,arguments,_)}else x=f.apply(this,arguments);return p(this,x)}}function p(s,o){return o&&(k(o)==="object"||typeof o=="function")?o:u(s)}function u(s){if(s===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return s}function e(){if(typeof Reflect=="undefined"||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(s){return!1}}function l(s){return l=Object.setPrototypeOf?Object.getPrototypeOf:function(c){return c.__proto__||Object.getPrototypeOf(c)},l(s)}function r(s,o,c){return o in s?Object.defineProperty(s,o,{value:c,enumerable:!0,configurable:!0,writable:!0}):s[o]=c,s}var w=3,P=2,j=1,I=[],m=function s(o,c,f){for(var x=c||"0",_=f||I,E=[],n=0;n<w;n++){var t="".concat(x,"-").concat(n);_.push({title:t,key:t}),n<P&&E.push(t)}if(o<0)return _;var a=o-1;E.forEach(function(i,O){return _[O].children=[],s(a,i,_[O].children)})};m(j);var y=function(s){F(c,s);var o=g(c);function c(){var f;R(this,c);for(var x=arguments.length,_=new Array(x),E=0;E<x;E++)_[E]=arguments[E];return f=o.call.apply(o,[this].concat(_)),r(u(f),"state",{gData:I,expandedKeys:["0-0","0-0-0","0-0-0-0"]}),r(u(f),"onDragEnter",function(n){console.log(n)}),r(u(f),"onDrop",function(n){console.log(n);var t=n.node.props.eventKey,a=n.dragNode.props.eventKey,i=n.node.props.pos.split("-"),O=n.dropPosition-Number(i[i.length-1]),L=function $(Y,X,Z){for(var Q=0;Q<Y.length;Q++){if(Y[Q].key===X)return Z(Y[Q],Q,Y);Y[Q].children&&$(Y[Q].children,X,Z)}},U=b(f.state.gData),M;if(L(U,a,function($,Y,X){X.splice(Y,1),M=$}),!n.dropToGap)L(U,t,function($){$.children=$.children||[],$.children.push(M)});else if((n.node.props.children||[]).length>0&&n.node.props.expanded&&O===1)L(U,t,function($){$.children=$.children||[],$.children.unshift(M)});else{var J,G;L(U,t,function($,Y,X){J=X,G=Y}),O===-1?J.splice(G,0,M):J.splice(G+1,0,M)}f.setState({gData:U})}),f}return W(c,[{key:"render",value:function(){return h.createElement(v.Tree,{className:"draggable-tree",defaultExpandedKeys:this.state.expandedKeys,draggable:!0,blockNode:!0,onDragEnter:this.onDragEnter,onDrop:this.onDrop,treeData:this.state.gData})}}]),c}(h.Component);return h.createElement(y,null)}}},3977:function(T,V,d){T.exports={content:{"zh-CN":[["p","点击展开节点，动态加载数据。"]],"en-US":[["p","To load data asynchronously when click to expand a treeNode."]]},meta:{order:3,title:{"zh-CN":"异步数据加载","en-US":"load data asynchronously"},filename:"components/tree/demo/dynamic.md",id:"components-tree-demo-dynamic"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>
`},preview:function(){var h=d(0),H=d(26),v=S(d(0)),k=d(9);function b(){if(typeof WeakMap!="function")return null;var n=new WeakMap;return b=function(){return n},n}function S(n){if(n&&n.__esModule)return n;if(n===null||D(n)!=="object"&&typeof n!="function")return{default:n};var t=b();if(t&&t.has(n))return t.get(n);var a={},i=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var O in n)if(Object.prototype.hasOwnProperty.call(n,O)){var L=i?Object.getOwnPropertyDescriptor(n,O):null;L&&(L.get||L.set)?Object.defineProperty(a,O,L):a[O]=n[O]}return a.default=n,t&&t.set(n,a),a}function D(n){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?D=function(a){return typeof a}:D=function(a){return a&&typeof Symbol=="function"&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},D(n)}function C(n){return R(n)||K(n)||j(n)||N()}function N(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function K(n){if(typeof Symbol!="undefined"&&Symbol.iterator in Object(n))return Array.from(n)}function R(n){if(Array.isArray(n))return I(n)}function z(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function")}function W(n,t){for(var a=0;a<t.length;a++){var i=t[a];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}function F(n,t,a){return t&&W(n.prototype,t),a&&W(n,a),n}function A(n,t){if(typeof t!="function"&&t!==null)throw new TypeError("Super expression must either be null or a function");n.prototype=Object.create(t&&t.prototype,{constructor:{value:n,writable:!0,configurable:!0}}),t&&g(n,t)}function g(n,t){return g=Object.setPrototypeOf||function(i,O){return i.__proto__=O,i},g(n,t)}function p(n){var t=l();return function(){var i=r(n),O;if(t){var L=r(this).constructor;O=Reflect.construct(i,arguments,L)}else O=i.apply(this,arguments);return u(this,O)}}function u(n,t){return t&&(D(t)==="object"||typeof t=="function")?t:e(n)}function e(n){if(n===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return n}function l(){if(typeof Reflect=="undefined"||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(n){return!1}}function r(n){return r=Object.setPrototypeOf?Object.getPrototypeOf:function(a){return a.__proto__||Object.getPrototypeOf(a)},r(n)}function w(n,t){return y(n)||m(n,t)||j(n,t)||P()}function P(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function j(n,t){if(!n)return;if(typeof n=="string")return I(n,t);var a=Object.prototype.toString.call(n).slice(8,-1);if(a==="Object"&&n.constructor&&(a=n.constructor.name),a==="Map"||a==="Set")return Array.from(n);if(a==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(a))return I(n,t)}function I(n,t){(t==null||t>n.length)&&(t=n.length);for(var a=0,i=new Array(t);a<t;a++)i[a]=n[a];return i}function m(n,t){if(typeof Symbol=="undefined"||!(Symbol.iterator in Object(n)))return;var a=[],i=!0,O=!1,L=void 0;try{for(var U=n[Symbol.iterator](),M;!(i=(M=U.next()).done)&&!(a.push(M.value),t&&a.length===t);i=!0);}catch(J){O=!0,L=J}finally{try{!i&&U.return!=null&&U.return()}finally{if(O)throw L}}return a}function y(n){if(Array.isArray(n))return n}function s(n,t){var a=Object.keys(n);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(n);t&&(i=i.filter(function(O){return Object.getOwnPropertyDescriptor(n,O).enumerable})),a.push.apply(a,i)}return a}function o(n){for(var t=1;t<arguments.length;t++){var a=arguments[t]!=null?arguments[t]:{};t%2?s(Object(a),!0).forEach(function(i){c(n,i,a[i])}):Object.getOwnPropertyDescriptors?Object.defineProperties(n,Object.getOwnPropertyDescriptors(a)):s(Object(a)).forEach(function(i){Object.defineProperty(n,i,Object.getOwnPropertyDescriptor(a,i))})}return n}function c(n,t,a){return t in n?Object.defineProperty(n,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):n[t]=a,n}var f=[{title:"Expand to load",key:"0"},{title:"Expand to load",key:"1"},{title:"Tree Node",key:"2",isLeaf:!0}];function x(n,t,a){return n.map(function(i){return i.key===t?o(o({},i),{},{children:a}):i.children?o(o({},i),{},{children:x(i.children,t,a)}):i})}var _=function(){var t=(0,v.useState)(f),a=w(t,2),i=a[0],O=a[1];function L(U){var M=U.key,J=U.children;return new Promise(function(G){if(J){G();return}setTimeout(function(){O(function($){return x($,M,[{title:"Child Node",key:"".concat(M,"-0")},{title:"Child Node",key:"".concat(M,"-1")}])}),G()},1e3)})}return v.default.createElement(k.Tree,{loadData:L,treeData:i})},E=function(n){A(a,n);var t=p(a);function a(){var i;z(this,a);for(var O=arguments.length,L=new Array(O),U=0;U<O;U++)L[U]=arguments[U];return i=t.call.apply(t,[this].concat(L)),c(e(i),"state",{treeData:[{title:"Expand to load",key:"0"},{title:"Expand to load",key:"1"},{title:"Tree Node",key:"2",isLeaf:!0}]}),c(e(i),"onLoadData",function(M){var J=i.state.treeData;return new Promise(function(G){var $=M.props;if(M.children){G();return}setTimeout(function(){M.children=[{title:"Child Node",key:"".concat(M.eventKey,"-0")},{title:"Child Node",key:"".concat(M.eventKey,"-1")}],i.setState({treeData:C(i.state.treeData)}),G()},1e3)})}),i}return F(a,[{key:"render",value:function(){return v.default.createElement(k.Tree,{loadData:this.onLoadData,treeData:this.state.treeData})}}]),a}(v.default.Component);return v.default.createElement(_,null)}}},3978:function(T,V,d){T.exports={content:{"zh-CN":[["p","节点之间带连接线的树，常用于文件目录结构展示。使用 ",["code","showLine"]," 开启，可以用 ",["code","switcherIcon"]," 修改默认图标。"]],"en-US":[["p","Tree with connected line between nodes, turn on by ",["code","showLine"],", customize the preseted icon by ",["code","switcherIcon"],"."]]},meta:{order:5,title:{"zh-CN":"连接线","en-US":"Tree with line"},filename:"components/tree/demo/line.md",id:"components-tree-demo-line"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>
`},preview:function(){var h=d(0),H=d(26);function v(p){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?v=function(e){return typeof e}:v=function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},v(p)}var k=C(d(0)),b=d(9),S=d(51);function D(){if(typeof WeakMap!="function")return null;var p=new WeakMap;return D=function(){return p},p}function C(p){if(p&&p.__esModule)return p;if(p===null||v(p)!=="object"&&typeof p!="function")return{default:p};var u=D();if(u&&u.has(p))return u.get(p);var e={},l=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var r in p)if(Object.prototype.hasOwnProperty.call(p,r)){var w=l?Object.getOwnPropertyDescriptor(p,r):null;w&&(w.get||w.set)?Object.defineProperty(e,r,w):e[r]=p[r]}return e.default=p,u&&u.set(p,e),e}function N(p,u){return F(p)||W(p,u)||R(p,u)||K()}function K(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function R(p,u){if(!p)return;if(typeof p=="string")return z(p,u);var e=Object.prototype.toString.call(p).slice(8,-1);if(e==="Object"&&p.constructor&&(e=p.constructor.name),e==="Map"||e==="Set")return Array.from(p);if(e==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e))return z(p,u)}function z(p,u){(u==null||u>p.length)&&(u=p.length);for(var e=0,l=new Array(u);e<u;e++)l[e]=p[e];return l}function W(p,u){if(typeof Symbol=="undefined"||!(Symbol.iterator in Object(p)))return;var e=[],l=!0,r=!1,w=void 0;try{for(var P=p[Symbol.iterator](),j;!(l=(j=P.next()).done)&&!(e.push(j.value),u&&e.length===u);l=!0);}catch(I){r=!0,w=I}finally{try{!l&&P.return!=null&&P.return()}finally{if(r)throw w}}return e}function F(p){if(Array.isArray(p))return p}var A=[{title:"parent 1",key:"0-0",icon:k.default.createElement(S.CarryOutOutlined,null),children:[{title:"parent 1-0",key:"0-0-0",icon:k.default.createElement(S.CarryOutOutlined,null),children:[{title:"leaf",key:"0-0-0-0",icon:k.default.createElement(S.CarryOutOutlined,null)},{title:"leaf",key:"0-0-0-1",icon:k.default.createElement(S.CarryOutOutlined,null)},{title:"leaf",key:"0-0-0-2",icon:k.default.createElement(S.CarryOutOutlined,null)}]},{title:"parent 1-1",key:"0-0-1",icon:k.default.createElement(S.CarryOutOutlined,null),children:[{title:"leaf",key:"0-0-1-0",icon:k.default.createElement(S.CarryOutOutlined,null)}]},{title:"parent 1-2",key:"0-0-2",icon:k.default.createElement(S.CarryOutOutlined,null),children:[{title:"leaf",key:"0-0-2-0",icon:k.default.createElement(S.CarryOutOutlined,null)},{title:"leaf",key:"0-0-2-1",icon:k.default.createElement(S.CarryOutOutlined,null),switcherIcon:k.default.createElement(S.FormOutlined,null)}]}]}],g=function(){var u=(0,k.useState)(!0),e=N(u,2),l=e[0],r=e[1],w=(0,k.useState)(!1),P=N(w,2),j=P[0],I=P[1],m=(0,k.useState)(!0),y=N(m,2),s=y[0],o=y[1],c=function(E,n){console.log("selected",E,n)},f=function(E){o(E),r({showLeafIcon:E})},x=function(E){r(E&&(s?E:{showLeafIcon:s}))};return k.default.createElement("div",null,k.default.createElement("div",{style:{marginBottom:16}},"showLine: ",k.default.createElement(b.Switch,{checked:l,onChange:x}),k.default.createElement("br",null),k.default.createElement("br",null),"showIcon: ",k.default.createElement(b.Switch,{checked:j,onChange:I}),k.default.createElement("br",null),k.default.createElement("br",null),"showLeafIcon: ",k.default.createElement(b.Switch,{checked:s,onChange:f})),k.default.createElement(b.Tree,{showLine:l,showIcon:j,defaultExpandedKeys:["0-0-0"],onSelect:c,treeData:A}))};return k.default.createElement(g,null)}}},3979:function(T,V,d){T.exports={content:{"zh-CN":[["p","可搜索的树。"]],"en-US":[["p","Searchable Tree."]]},meta:{order:4,title:{"zh-CN":"可搜索","en-US":"Searchable"},filename:"components/tree/demo/search.md",id:"components-tree-demo-search"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree<span class="token punctuation">,</span> Input <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">SearchTree</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function(){var h=d(0),H=d(26),v=d(9);function k(m){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?k=function(s){return typeof s}:k=function(s){return s&&typeof Symbol=="function"&&s.constructor===Symbol&&s!==Symbol.prototype?"symbol":typeof s},k(m)}function b(m,y){if(!(m instanceof y))throw new TypeError("Cannot call a class as a function")}function S(m,y){for(var s=0;s<y.length;s++){var o=y[s];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(m,o.key,o)}}function D(m,y,s){return y&&S(m.prototype,y),s&&S(m,s),m}function C(m,y){if(typeof y!="function"&&y!==null)throw new TypeError("Super expression must either be null or a function");m.prototype=Object.create(y&&y.prototype,{constructor:{value:m,writable:!0,configurable:!0}}),y&&N(m,y)}function N(m,y){return N=Object.setPrototypeOf||function(o,c){return o.__proto__=c,o},N(m,y)}function K(m){var y=W();return function(){var o=F(m),c;if(y){var f=F(this).constructor;c=Reflect.construct(o,arguments,f)}else c=o.apply(this,arguments);return R(this,c)}}function R(m,y){return y&&(k(y)==="object"||typeof y=="function")?y:z(m)}function z(m){if(m===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return m}function W(){if(typeof Reflect=="undefined"||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(m){return!1}}function F(m){return F=Object.setPrototypeOf?Object.getPrototypeOf:function(s){return s.__proto__||Object.getPrototypeOf(s)},F(m)}function A(m,y,s){return y in m?Object.defineProperty(m,y,{value:s,enumerable:!0,configurable:!0,writable:!0}):m[y]=s,m}var g=v.Input.Search,p=3,u=2,e=1,l=[],r=function m(y,s,o){for(var c=s||"0",f=o||l,x=[],_=0;_<p;_++){var E="".concat(c,"-").concat(_);f.push({title:E,key:E}),_<u&&x.push(E)}if(y<0)return f;var n=y-1;x.forEach(function(t,a){return f[a].children=[],m(n,t,f[a].children)})};r(e);var w=[],P=function m(y){for(var s=0;s<y.length;s++){var o=y[s],c=o.key;w.push({key:c,title:c}),o.children&&m(o.children)}};P(l);var j=function m(y,s){for(var o,c=0;c<s.length;c++){var f=s[c];f.children&&(f.children.some(function(x){return x.key===y})?o=f.key:m(y,f.children)&&(o=m(y,f.children)))}return o},I=function(m){C(s,m);var y=K(s);function s(){var o;b(this,s);for(var c=arguments.length,f=new Array(c),x=0;x<c;x++)f[x]=arguments[x];return o=y.call.apply(y,[this].concat(f)),A(z(o),"state",{expandedKeys:[],searchValue:"",autoExpandParent:!0}),A(z(o),"onExpand",function(_){o.setState({expandedKeys:_,autoExpandParent:!1})}),A(z(o),"onChange",function(_){var E=_.target.value,n=w.map(function(t){return t.title.indexOf(E)>-1?j(t.key,l):null}).filter(function(t,a,i){return t&&i.indexOf(t)===a});o.setState({expandedKeys:n,searchValue:E,autoExpandParent:!0})}),o}return D(s,[{key:"render",value:function(){var c=this.state,f=c.searchValue,x=c.expandedKeys,_=c.autoExpandParent,E=function n(t){return t.map(function(a){var i=a.title.indexOf(f),O=a.title.substr(0,i),L=a.title.substr(i+f.length),U=i>-1?h.createElement("span",null,O,h.createElement("span",{className:"site-tree-search-value"},f),L):h.createElement("span",null,a.title);return a.children?{title:U,key:a.key,children:n(a.children)}:{title:U,key:a.key}})};return h.createElement("div",null,h.createElement(g,{style:{marginBottom:8},placeholder:"Search",onChange:this.onChange}),h.createElement(v.Tree,{onExpand:this.onExpand,expandedKeys:x,autoExpandParent:_,treeData:E(l)}))}}]),s}(h.Component);return h.createElement(I,null)},style:`.site-tree-search-value {
  color: #f50;
}
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function(){var h=d(0),H=d(26),v=d(9),k=d(51);function b(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?b=function(r){return typeof r}:b=function(r){return r&&typeof Symbol=="function"&&r.constructor===Symbol&&r!==Symbol.prototype?"symbol":typeof r},b(e)}function S(e,l){if(!(e instanceof l))throw new TypeError("Cannot call a class as a function")}function D(e,l){for(var r=0;r<l.length;r++){var w=l[r];w.enumerable=w.enumerable||!1,w.configurable=!0,"value"in w&&(w.writable=!0),Object.defineProperty(e,w.key,w)}}function C(e,l,r){return l&&D(e.prototype,l),r&&D(e,r),e}function N(e,l){if(typeof l!="function"&&l!==null)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(l&&l.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),l&&K(e,l)}function K(e,l){return K=Object.setPrototypeOf||function(w,P){return w.__proto__=P,w},K(e,l)}function R(e){var l=F();return function(){var w=A(e),P;if(l){var j=A(this).constructor;P=Reflect.construct(w,arguments,j)}else P=w.apply(this,arguments);return z(this,P)}}function z(e,l){return l&&(b(l)==="object"||typeof l=="function")?l:W(e)}function W(e){if(e===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function F(){if(typeof Reflect=="undefined"||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(e){return!1}}function A(e){return A=Object.setPrototypeOf?Object.getPrototypeOf:function(r){return r.__proto__||Object.getPrototypeOf(r)},A(e)}function g(e,l,r){return l in e?Object.defineProperty(e,l,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[l]=r,e}var p=v.Tree.TreeNode,u=function(e){N(r,e);var l=R(r);function r(){var w;S(this,r);for(var P=arguments.length,j=new Array(P),I=0;I<P;I++)j[I]=arguments[I];return w=l.call.apply(l,[this].concat(j)),g(W(w),"onSelect",function(m,y){console.log("selected",m,y)}),w}return C(r,[{key:"render",value:function(){return h.createElement(v.Tree,{showLine:!0,switcherIcon:h.createElement(k.DownOutlined,null),defaultExpandedKeys:["0-0-0"],onSelect:this.onSelect},h.createElement(p,{title:"parent 1",key:"0-0"},h.createElement(p,{title:"parent 1-0",key:"0-0-0"},h.createElement(p,{title:"leaf",key:"0-0-0-0"}),h.createElement(p,{title:"leaf",key:"0-0-0-1"}),h.createElement(p,{title:"leaf",key:"0-0-0-2"})),h.createElement(p,{title:"parent 1-1",key:"0-0-1"},h.createElement(p,{title:"leaf",key:"0-0-1-0"})),h.createElement(p,{title:"parent 1-2",key:"0-0-2"},h.createElement(p,{title:"leaf",key:"0-0-2-0"}),h.createElement(p,{title:"leaf",key:"0-0-2-1"}))))}}]),r}(h.Component);return h.createElement(u,null)}}},3981:function(T,V,d){T.exports={content:{"zh-CN":[["p","使用 ",["code","height"]," 属性则切换为虚拟滚动。"]],"en-US":[["p","Use virtual list through ",["code","height"]," prop."]]},meta:{order:9,title:{"zh-CN":"虚拟滚动","en-US":"Virtual scroll"},filename:"components/tree/demo/virtual-scroll.md",id:"components-tree-demo-virtual-scroll"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Tree</span></span> <span class="token attr-name">treeData</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span>treeData<span class="token punctuation">}</span></span> <span class="token attr-name">height</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span><span class="token number">233</span><span class="token punctuation">}</span></span> <span class="token attr-name">defaultExpandAll</span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function(){var h=d(0),H=d(26),v=d(9);function k(){for(var S=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"0",D=arguments.length>1&&arguments[1]!==void 0?arguments[1]:3,C=[],N=0;N<10;N+=1){var K="".concat(S,"-").concat(N),R={title:K,key:K};D>0&&(R.children=k(K,D-1)),C.push(R)}return C}var b=k();return h.createElement(v.Tree,{treeData:b,height:233,defaultExpandAll:!0})}}}}]);
